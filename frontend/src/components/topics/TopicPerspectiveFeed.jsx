...
import { useGetAllPerspectivesForTopicQuery } from '../../slices/api_slices/topicsApiSlice';
...
const TopicPerspectiveFeeds = ({topicId}) => {
  ...
  const { data, error, isLoading, isSuccess, isError, refetch } = useGetAllPerspectivesForTopicQuery({
    topicId,
    pageNum : page,
    limitNum : 10
...
TopicPerspectiveFeeds.propTypes = {
  topicId: PropTypes.string.isRequired,
}

export default TopicPerspectiveFeeds;
