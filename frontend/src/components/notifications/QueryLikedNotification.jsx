...
const QueryLikedNotification = ({ userData, notification, queryData }) => {
    ...
    <NotificationCard sx={{backgroundColor : (isRead ? "#00000" : "#e8e8e8"), minWidth:'400px'}}>
      ...
      <CardContent sx={{ flex: 1 }}>
        <Typography variant="body1">
          <strong>{userData?.name}</strong> Liked your query {queryData?.title}.
...
QueryLikedNotification.propTypes = {
  userData: PropTypes.object.isRequired,
  notification: PropTypes.object.isRequired,
  queryData: PropTypes.object.isRequired,
};

export default QueryLikedNotification;
