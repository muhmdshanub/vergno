...
const PerspectiveLikedNotification = ({ userData, notification , perspectiveData}) => {
    ...
    <NotificationCard sx={{backgroundColor : (isRead ? "#00000" : "#e8e8e8"), minWidth:'400px'}}>
      ...
      <CardContent sx={{ flex: 1 }}>
        <Typography variant="body1">
          <strong>{userData?.name}</strong> Liked your perspective <span>{perspectiveData?.title}</span>.
        </Typography>
      </CardContent>
...
PerspectiveLikedNotification.propTypes = {
  userData: PropTypes.object.isRequired,
  notification: PropTypes.object.isRequired,
  perspectiveData: PropTypes.object.isRequired,
};


export default PerspectiveLikedNotification;
