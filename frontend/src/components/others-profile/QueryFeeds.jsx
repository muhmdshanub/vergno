...
import { useGetAllQueriesForOtherUserProfileQuery } from '../../slices/api_slices/profileApiSlice';
...
const QueryFeeds = ({userId}) => {
  ...
  const { data, error, isLoading, isSuccess, isError, refetch } = useGetAllQueriesForOtherUserProfileQuery({
    userId,
    pageNum : page,
    limitNum : 10
