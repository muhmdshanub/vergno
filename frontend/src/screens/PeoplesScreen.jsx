...
import SuggestionPeoples from '../components/peoples/SuggestionPeoples';
import FollowersPeople from '../components/peoples/FollowersPeople';
import FollowingPeople from '../components/peoples/FollowingPeople';
import FollowRequestPeople from '../components/peoples/FollowRequestPeople';
import { useLocation } from 'react-router-dom';
import BlockedPeople from '../components/peoples/BlockedPeople';
...
const options = [
  { text: 'Suggestions', component: SuggestionPeoples },
  { text: 'Blocked', component: BlockedPeople },
  { text: 'Following', component: FollowingPeople },
  { text: 'Followers', component: FollowersPeople },
  { text: 'Requests', component: FollowRequestPeople },
];
...
const PeoplesScreen = () => {
  ...
  return (
    <Grid container spacing={2}>
      <Grid item xs={12} sm={12} md={10} lg={8} sx={{ margin: '0 auto',  backgroundColor:'transparent' }}>
        <Paper elevation={3} sx={{ width: '100%', position:"relative", backgroundColor:'transparent' }}>
          ...
          {options.map((option, index) => (
            <GlassmorphicTabPanel key={`strong_tab_panel_${index}`} value={value} index={index} >
